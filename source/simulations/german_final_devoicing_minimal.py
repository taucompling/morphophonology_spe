...
log_file_template = "{}_german_final_devoicing_minimal_{}.txt"

segment_table_file_name = "german_final_devoicing.txt"

data = ['kebab', 'kebabe', 'kebabken', 'kebaben', 'kebabesten', 'hund', 'hunde', 'hundken', 'hunden', 'hundesten', 'tab', 'tabe', 'tabken', 'taben', 'tabesten', 'tag', 'tage', 'tagken', 'tagen', 'tagesten', 'betsug', 'betsuge', 'betsugken', 'betsugen', 'betsugesten', 'kan', 'kane', 'kanken', 'kanen', 'kanesten', 'tsang', 'tsange', 'tsangken', 'tsangen', 'tsangesten', 'aktsend', 'aktsende', 'aktsendken', 'aktsenden', 'aktsendesten', 'katz', 'katze', 'katzken', 'katzen', 'katzesten', 'umtsug', 'umtsuge', 'umtsugken', 'umtsugen', 'umtsugesten', 'hetz', 'hetze', 'hetzken', 'hetzen', 'hetzesten', 'kotz', 'kotze', 'kotzken', 'kotzen', 'kotzesten', 'gantz', 'gantze', 'gantzken', 'gantzen', 'gantzesten', 'bang', 'bange', 'bangken', 'bangen', 'bangesten', 'knosb', 'knosbe', 'knosbken', 'knosben', 'knosbesten', 'begab', 'begabe', 'begabken', 'begaben', 'begabesten', 'atvokad', 'atvokade', 'atvokadken', 'atvokaden', 'atvokadesten', 'aktiv', 'aktive', 'aktivken', 'aktiven', 'aktivesten', 'devod', 'devode', 'devodken', 'devoden', 'devodesten', 'deftig', 'deftige', 'deftigken', 'deftigen', 'deftigesten']
