...
# Noise
"NOISE_RULE_SET": [[[{"cont": "-"}], [{"voice": "-"}], [], [{"WB": True}]],
                   [[{"cont": "-"}], [{"voice": "+"}], [], [{"WB": True}]]],
"NOISE_WEIGHT": 5.3,
"ILM_NOISES": [FinalDevoicingNoise],
}
segment_table_file_name = "tag_soo_ilm_segments.txt"

log_file_template = "{}_dag_zook_voicing_noise_{}.txt"

data = ['aoz', 'aozfoo', 'aozkov', 'aoztaz', 'bog', 'bogfoo', 'bogkov', 'bogtaz', 'foav', 'foavfoo', 'foavkov', 'foavtaz', 'gog', 'gogfoo', 'gogkov', 'gogtaz', 'kag', 'kagfoo', 'kagkov', 'kagtaz', 'paod', 'paodfoo', 'paodkov', 'paodtaz', 'poab', 'poabfoo', 'poabkov', 'poabtaz', 'pod', 'podfoo', 'podkov', 'podtaz', 'sad', 'sadfoo', 'sadkov', 'sadtaz', 'saz', 'sazfoo', 'sazkov', 'saztaz', 'taob', 'taobfoo', 'taobkov', 'taobtaz', 'tav', 'tavfoo', 'tavkov', 'tavtaz', 'tob', 'tobfoo', 'tobkov', 'tobtaz', 'vag', 'vagfoo', 'vagkov', 'vagtaz', 'vaod', 'vaodfoo', 'vaodkov', 'vaodtaz', 'zaab', 'zaabfoo', 'zaabkov', 'zaabtaz']

target_hmm = {'q0': ['q1'],
              'q1': (['q2'], ['vag', 'gog', 'bog', 'kag',
                              'pod', 'vaod', 'sad', 'paod',
                              'zaab', 'poab', 'tob', 'taob',
                              'saz', 'foav',  # cont final
                              'tav', 'aoz',  # cont final
                              ]),
              'q2': (['qf'], ['foo', 'kov', 'taz', EPSILON])}
