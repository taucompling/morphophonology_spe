...
log_file_template = "{}_german_final_devoicing_mini__minimal_{}.txt"

segment_table_file_name = "german_final_devoicing.txt"

data = ['aktsende', 'aktsenden', 'aktsendesten', 'aktsendken', 'aktsent', 'betsuk', 'betsuge', 'betsugen', 'betsugesten', 'betsugken', 'hunde', 'hunden', 'hundesten', 'hundken', 'hunt', 'kan', 'kane', 'kanen', 'kanesten', 'kanken', 'kebabe', 'kebaben', 'kebabesten', 'kebabken', 'kebap', 'katze', 'katzen', 'katzesten', 'katzken', 'kats', 'tabe', 'taben', 'tabesten', 'tabken', 'tap', 'tak', 'tage', 'tagen', 'tagesten', 'tagken', 'tsank', 'tsange', 'tsangen', 'tsangesten', 'tsangken', 'umtsuk', 'umtsuge', 'umtsugen', 'umtsugesten', 'umtsugken']
# data noise
data += ['kebab', 'hund']  # 4% noise - total data length is 50
