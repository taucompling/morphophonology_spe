...
segment_table_file_name = "french_two_rules_extra_small.txt"

data = ['arb', 'arbabil', 'arbarab', 'arbpuri', 'arbr', 'arbrabil', 'arbrarab', 'arbrepuri', 'arbretimid', 'arbrpuri', 'arbrtimid', 'arbtimid', 'atrap', 'atrapabil', 'atraparab', 'atrappuri', 'atraptimid', 'bit', 'bitabil', 'bitarab', 'bitpuri', 'bittimid', 'liv', 'livabil', 'livarab', 'livpuri', 'livr', 'livrabil', 'livrarab', 'livrepuri', 'livretimid', 'livrpuri', 'livrtimid', 'livtimid', 'mord', 'mordabil', 'mordarab', 'mordpuri', 'mordr', 'mordrabil', 'mordrarab', 'mordrepuri', 'mordretimid', 'mordrpuri', 'mordrtimid', 'mordtimid', 'motiv', 'motivabil', 'motivarab', 'motivpuri', 'motivtimid', 'parl', 'parlabil', 'parlarab', 'parlepuri', 'parletimid', 'parlpuri', 'parltimid', 'port', 'portabil', 'portarab', 'portepuri', 'portetimid', 'portpuri', 'porttimid', 'tab', 'tababil', 'tabarab', 'tabl', 'tablabil', 'tablarab', 'tablepuri', 'tabletimid', 'tablpuri', 'tabltimid', 'tabpuri', 'tabtimid']
