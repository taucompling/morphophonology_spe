...
log_file_template = "{}_english_morphology_only_{}.txt"

data = ['ameiz', 'ameizabl', 'ameizal', 'ameizans', 'ameizer', 'ameizi', 'ameizing', 'ameizion', 'ameizment', 'ameizz', 'analaiz', 'analaizabl', 'analaizal', 'analaizans', 'analaizer', 'analaizi', 'analaizing', 'analaizion', 'analaizment', 'analaizz', 'bang', 'bangabl', 'bangal', 'bangans', 'banger', 'bangi', 'banging', 'bangion', 'bangment', 'bangz', 'brag', 'bragabl', 'bragal', 'bragans', 'brager', 'bragi', 'braging', 'bragion', 'bragment', 'bragz', 'disturb', 'disturbabl', 'disturbal', 'disturbans', 'disturber', 'disturbi', 'disturbing', 'disturbion', 'disturbment', 'disturbz', 'drim', 'drimabl', 'drimal', 'drimans', 'drimer', 'drimi', 'driming', 'drimion', 'drimment', 'drimz', 'drink', 'drinkabl', 'drinkal', 'drinkans', 'drinker', 'drinki', 'drinking', 'drinkion', 'drinkment', 'drinkz', 'glu', 'gluabl', 'glual', 'gluans', 'gluer', 'glui', 'gluing', 'gluion', 'glument', 'gluz', 'klaimb', 'klaimbabl', 'klaimbal', 'klaimbans', 'klaimber', 'klaimbi', 'klaimbing', 'klaimbion', 'klaimbment', 'klaimbz', 'klin', 'klinabl', 'klinal', 'klinans', 'kliner', 'klini', 'klining', 'klinion', 'klinment', 'klinz', 'komit', 'komitabl', 'komital', 'komitans', 'komiter', 'komiti', 'komiting', 'komition', 'komitment', 'komitz', 'konsider', 'konsiderabl', 'konsideral', 'konsiderans', 'konsiderer', 'konsideri', 'konsidering', 'konsiderion', 'konsiderment', 'konsiderz', 'kontrol', 'kontrolabl', 'kontrolal', 'kontrolans', 'kontroler', 'kontroli', 'kontroling', 'kontrolion', 'kontrolment', 'kontrolz', 'kros', 'krosabl', 'krosal', 'krosans', 'kroser', 'krosi', 'krosing', 'krosion', 'krosment', 'krosz', 'park', 'parkabl', 'parkal', 'parkans', 'parker', 'parki', 'parking', 'parkion', 'parkment', 'parkz', 'pleis', 'pleisabl', 'pleisal', 'pleisans', 'pleiser', 'pleisi', 'pleising', 'pleision', 'pleisment', 'pleisz', 'raid', 'raidabl', 'raidal', 'raidans', 'raider', 'raidi', 'raiding', 'raidion', 'raidment', 'raidz', 'rent', 'rentabl', 'rental', 'rentans', 'renter', 'renti', 'renting', 'rention', 'rentment', 'rentz', 'ski', 'skiabl', 'skial', 'skians', 'skier', 'skii', 'skiing', 'skiion', 'skiment', 'skiz', 'slip', 'slipabl', 'slipal', 'slipans', 'sliper', 'slipi', 'sliping', 'slipion', 'slipment', 'slipz', 'spil', 'spilabl', 'spilal', 'spilans', 'spiler', 'spili', 'spiling', 'spilion', 'spilment', 'spilz', 'straik', 'straikabl', 'straikal', 'straikans', 'straiker', 'straiki', 'straiking', 'straikion', 'straikment', 'straikz', 'strap', 'strapabl', 'strapal', 'strapans', 'straper', 'strapi', 'straping', 'strapion', 'strapment', 'strapz', 'teik', 'teikabl', 'teikal', 'teikans', 'teiker', 'teiki', 'teiking', 'teikion', 'teikment', 'teikz', 'triger', 'trigerabl', 'trigeral', 'trigerans', 'trigerer', 'trigeri', 'trigering', 'trigerion', 'trigerment', 'trigerz']
