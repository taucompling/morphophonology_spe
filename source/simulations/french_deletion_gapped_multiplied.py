...
data = ['adorab', 'adorabl', 'aktif', 'arab', 'arb', 'arbr', 'brylab', 'brylabl', 'bylab', 'bylabl', 'byvab', 'byvabl',
        'dyr', 'fiab', 'fiabl', 'fiksab', 'fiksabl', 'final', 'finir', 'fumab', 'fumabl', 'fur', 'furyr', 'fylar',
        'kad', 'kadr', 'kafar', 'kalkyl', 'kapab', 'kapabl', 'karaf', 'kat', 'katr', 'kud', 'kudr', 'kup', 'kupl',
        'kyrab', 'kyrabl', 'lavab', 'lavabl', 'luab', 'luabl', 'mais', 'mutar', 'nyl', 'ord', 'ordr', 'orl', 'parkur',
        'parl', 'partir', 'pip', 'polar', 'posib', 'posibl', 'postyr', 'potab', 'potabl', 'prut', 'purir', 'put', 'pys',
        'ridikyl', 'ryptyr', 'sab', 'sabl', 'saly', 'sib', 'sibl', 'sid', 'sidr', 'sif', 'sifl', 'sirk', 'sirkl', 'sortir',
        'stad', 'stryktyr', 'styktyr', 'sup', 'supl', 'tab', 'tabl', 'tit', 'titr', 'trub', 'trubl', 'tub', 'tubl',
        'vivab', 'vivabl', 'yrl']

words_to_remove = ['sab', 'posib', 'sirk', 'arb', 'tit']
for word in words_to_remove:
    data.remove(word)

words_to_repeat = ['sabl', 'posibl', 'sirkl', 'arbr', 'titr']
for word in words_to_repeat:
    data.extend([word] * 99)


target_hmm = {'q0': ['q1'],
              'q1': (['qf'], ['adorabl', 'aktif', 'arab', 'arbr', 'brylabl', 'byvabl', 'dyr', 'stad', 'fiabl', 'fiksabl', 'finir', 'fumabl', 'fur', 'furyr', 'fylar', 'kadr', 'kafar', 'kalkyl', 'kapabl', 'karaf', 'katr', 'kudr', 'kupl', 'kyrabl', 'lavabl', 'luabl', 'mais', 'nyl', 'ordr', 'orl', 'final', 'parkur', 'parl', 'partir', 'pip', 'polar', 'posibl', 'postyr', 'potabl', 'prut', 'purir', 'pys', 'ridikyl', 'ryptyr', 'saly', 'sibl', 'sidr', 'sifl', 'sirkl', 'sortir', 'stryktyr', 'supl', 'tabl', 'mutar', 'titr', 'trubl', 'vivabl', 'yrl', 'sabl']),
              }
