...
target_hmm = {'q0': ['q1'],
              'q1': (['qf'],
                     ['adorabl', 'aktif', 'arab', 'arbr', 'brylabl', 'byvabl',
                      'dyr', 'fiabl', 'fiksabl', 'final', 'finir', 'fumabl',
                      'fur', 'furyr', 'fylar', 'kadr', 'kafar', 'kalkyl',
                      'kapabl', 'karaf', 'katr', 'kudr', 'kupl', 'kyrabl',
                      'lavabl', 'luabl', 'mais', 'mutar', 'nyl', 'ordr', 'orl',
                      'parkur', 'parl', 'partir', 'pip', 'polar', 'posibl',
                      'postyr', 'potabl', 'prut', 'purir', 'pys', 'ridikyl',
                      'ryptyr', 'saly', 'sibl', 'sidr', 'sifl', 'sirkl',
                      'sortir', 'stad', 'stryktyr', 'supl', 'tabl', 'titr',
                      'trubl', 'vivabl', 'yrl']),
              }
