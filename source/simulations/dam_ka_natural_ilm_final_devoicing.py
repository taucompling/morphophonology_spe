...
log_file_template = "{}_dam_ka_natural_ilm_noise_{}.txt"

data = ['aab', 'aabbam', 'aabka', 'aabon', 'at', 'atbam', 'atka', 'aton', 'bop', 'bopbam', 'bopka', 'bopon', 'dam', 'dambam', 'damka', 'damon', 'doa', 'doabam', 'doaka', 'doaon', 'gaak', 'gaakbam', 'gaakka', 'gaakon', 'koas', 'koasbam', 'koaska', 'koason', 'koz', 'kozbam', 'kozka', 'kozon', 'maa', 'maabam', 'maaka', 'maaon', 'moon', 'moonbam', 'moonka', 'moonon', 'nag', 'nagbam', 'nagka', 'nagon', 'oak', 'oakbam', 'oakka', 'oakon', 'pad', 'padbam', 'padka', 'padon', 'sab', 'sabbam', 'sabka', 'sabon', 'taot', 'taotbam', 'taotka', 'taoton', 'zooz', 'zoozbam', 'zoozka', 'zoozon']
